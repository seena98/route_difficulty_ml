...
*   **Difficulty / Stress Score Scale (1.0 - 5.0)**: The numerical range our AI uses to evaluate the difficulty or stress level of a street segment. It is categorized into three comfort zones:
    *   *🟢 Easy Comfort (1.0 to 2.0):* Smooth, low-stress driving conditions. Typically represents wide, straight, well-lit roads with low traffic, or roads navigated by highly experienced drivers in small cars.
    *   *🟡 Moderate Stress (2.0 to 3.2):* Standard urban driving complexity. Includes primary roads with moderate traffic, standard cobblestone segments, or minor stress factors for average vehicles.
    *   *🔴 Hard/Difficult (3.2 to 5.0):* High-stress, challenging driving conditions. Triggered by combinations of narrow streets, large vehicles, unlit night conditions for older drivers, heavy rush-hour traffic, tram tracks, steep slopes, or winding geometry.
